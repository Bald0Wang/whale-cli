...
| 想构建垂直学习 Agent | 21 -> 29 | 能把领域资料、学习档案、知识结构、复习和项目陪学串成可持续闭环 |
...
| 28 | `28-学习项目空间-让数据持续隔离.md` | 项目级学习数据隔离与切换 | `web/server.py`, `soul/soul.py`, `webui/src/App.jsx` |
| 29 | `29-知识龙卷-把Datawhale内容做成学习产品.md` | 全量资料目录、主题归类、课程层级、搜索与来源链接 | `learning/tornado.py`, `tools/learning/`, `webui/src/App.jsx` |
